import { RouteParameters, RequestHandler, IRouter } from "express-serve-static-core";
...
// 	>(handler: RequestHandler<P, keyof ResBody extends never ? never : ResBody, ReqBody | undefined, ReqQuery, Locals>) => T
// }
